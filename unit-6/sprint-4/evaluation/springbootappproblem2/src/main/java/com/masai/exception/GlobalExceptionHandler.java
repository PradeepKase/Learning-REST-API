...
public class GlobalExceptionHandler {
	...
	@org.springframework.web.bind.annotation.ExceptionHandler(InsufficientFundException.class)
	public ResponseEntity<MyErrorDetail> InsufficientFundException(AccountException se, WebRequest req) {
